...
export const zh = {
  ...
  'file.uploaded': '文件已上传至 {path}',
  'file.uploadedMultiple': '已上传 {count} 个文件至临时目录',
  'file.uploadFailed': '文件上传失败：{error}',
...
export const en = {
  ...
  'file.uploaded': 'File uploaded to {path}',
  'file.uploadedMultiple': 'Uploaded {count} files to temporary folder',
  'file.uploadFailed': 'Failed to upload file: {error}',
